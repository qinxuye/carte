...
from parsers import MicroBlogParser, ForwardCommentLikeParser,\
                    ...
                    WeiqunParser, LikesMicroBlogParser
...
url_patterns = UrlPatterns(
    ...
    Url(r'http://q.weibo.com/profile/\d+', 'weiqun', WeiqunParser),
    Url(r'http://weibo.com/p/aj/mblog/mbloglist.*', 'likes_micro_blog', LikesMicroBlogParser),
)

def get_job():
    return Job('carte weibo crawler', url_patterns, MechanizeOpener, starts,
